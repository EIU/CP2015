...
public class DeadFraction {
	...
	static void solve(String number) {
		...
		long minNumerator = 0;
		long minDenominator = Integer.MAX_VALUE;
		for (int i = 2; i < len; i++) {
			int n1 = i == 2 ? 0 : Integer.parseInt(number.substring(2, i));
			int n2 = Integer.parseInt(number.substring(i, len));
	...
	static long[] decimalPower = new long[]{1, 10, 100, 1000, 10000, 100000, 1000000, 10000000,
